...
public class IsolatedExpManager : MonoBehaviour
{
...
/// </summary>
public class IsolatedBallPath
{
    public Vector3 Origin { get; set; }
    public Vector3 Destination { get; set; }
    public IsolatedBallOriginType BallOriginType { get; set; }
    public IsolatedBallDestType BallDestType { get; set; }
}
public enum IsolatedBallOriginType { left, center, right }
public enum IsolatedBallDestType { farLeft, centerLeft, center, centerRight, farRight }
